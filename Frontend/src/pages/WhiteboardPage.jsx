...
const WhiteboardPage = () => {
  ...
  const handleDelete = async () => {
    try {
      await fetch(`${backendUrl}/api/whiteboards/${id}`, {
        method: 'DELETE'
      });
      navigate('/');
    } catch (err) {
  ...
  if (!whiteboard) return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
      ...
      <h2 className="text-2xl font-bold text-gray-800 mb-2">Whiteboard Not Found</h2>
      <p className="text-gray-600 mb-6">The whiteboard you're looking for doesn't exist or may have been deleted.</p>
      <button
        onClick={() => navigate('/')}
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">{whiteboard.title}</h1>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-xl max-w-md w-full transform transition-all">
            <div className="text-center">
              ...
              <h3 className="mt-2 text-lg font-medium text-gray-900">Delete Whiteboard</h3>
